...
// Componente "AnimatedTextSlideInBottom" que acepta las props "text" y "className"
export const AnimatedTextSlideInBottom = ({ text, className = "" }) => {
  return (
    <div className="w-full mx-auto py-2 flex items-center justify-center text-center overflow-hidden">
      <motion.h1
        className={`inline-block w-full text-dark font-bold capitalize text-4xl ${className}`}
        variants={textSlideInBottom}
        initial="initial"
        animate="animate"
      >
